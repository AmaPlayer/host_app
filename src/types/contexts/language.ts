...
export type TranslationKey =
  ...
  | 'usernameRequired'
  | 'validEmailRequired'
  | 'yearsExperiencePositive'
  | 'nameUsernameDifferent'
  | 'usernameTaken'
  ...
  | 'masterLevel'
  | 'permissionDenied'
  | 'pleaseLogInParticipate'
  | 'pleaseLogIn'
  | 'competitionEndedMessage';
